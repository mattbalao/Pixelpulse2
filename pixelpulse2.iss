...
Source: "c:\projects\pixelpulse2\distrib\driver\amd64\*"; DestDir: "{app}\drivers\amd64"; Tasks: drivers
Source: "c:\projects\pixelpulse2\distrib\driver\x86\*"; DestDir: "{app}\drivers\x86"; Tasks: drivers
